    ...
    public Task AnOutsideAssemblyCannotDeriveFromResult() =>
        Verify.CompilerDiagnosticsAsync(
                ...
                where TOk : notnull where TErr : notnull
            {
                ...
                public override ValueTask<bool> IsOkAndAsync(Func<TOk, Task<bool>> predicate) => throw new Exception();
                ...
                public override ValueTask<bool> IsErrAndAsync(Func<TErr, Task<bool>> predicate) => throw new Exception();
                ...
                public override ValueTask<Result<TOk, TOut>> OrElseAsync<TOut>(Func<TErr, ValueTask<Result<TOk, TOut>>> resultFactory) => throw new Exception();
                ...
                public override ValueTask<TOk> UnwrapOrElseAsync(Func<TErr, Task<TOk>> valueFactory) => throw new Exception();
                ...
                public override ValueTask<Result<TOk, TErr>> InspectAsync(Func<TOk, Task> action) => throw new Exception();
                ...
                public override ValueTask<Result<TOk, TErr>> InspectErrAsync(Func<TErr, Task> action) => throw new Exception();
                ...
                public override ValueTask<Result<TOut, TErr>> MapAsync<TOut>(Func<TOk, Task<TOut>> map) => throw new Exception();
                ...
                public override ValueTask<TOut> MapOrAsync<TOut>(TOut defaultValue, Func<TOk, Task<TOut>> map) => throw new Exception();
                ...
                public override ValueTask<TOut> MapOrElseAsync<TOut>(Func<TErr, Task<TOut>> defaultFactory, Func<TOk, Task<TOut>> map) => throw new Exception();
                public override ValueTask<TOut> MapOrElseAsync<TOut>(Func<TErr, TOut> defaultFactory, Func<TOk, Task<TOut>> map) => throw new Exception();
                public override ValueTask<TOut> MapOrElseAsync<TOut>(Func<TErr, Task<TOut>> defaultFactory, Func<TOk, TOut> map) => throw new Exception();
                ...
                public override ValueTask<Result<TOk, TOut>> MapErrAsync<TOut>(Func<TErr, Task<TOut>> map) => throw new Exception();
