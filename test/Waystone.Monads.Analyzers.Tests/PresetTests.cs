...
/// in the build reads them — a rule added to <c>Rules.cs</c> without a matching entry
...
public class PresetTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Not hypothetical — the shipped id space has gaps at WM1004, WM1007, WM1009,
    ...
    /// path by construction, so the choice cannot matter — and if a section ever
