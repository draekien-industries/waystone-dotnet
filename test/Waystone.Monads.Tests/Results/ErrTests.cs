...
public class ErrTests
{
    ...
    public async Task WhenOrElseValueTaskAsync_ThenReturnOther()
    {
        ...
        (await err.OrElseAsync(_ =>
                new ValueTask<Result<int, bool>>(Result.Ok<int, bool>(1))))
           .ShouldBe(Result.Ok<int, bool>(1));
    ...
    public async Task WhenMapValueTaskAsync_ThenReturnError()
    {
        ...
        (await err.MapAsync(x => new ValueTask<int>(x + 1))).ShouldBe(
            Result.Err<int, string>("error"));
    }
    ...
    public async Task WhenMapOrValueTaskAsync_ThenReturnDefault()
    {
        ...
        (await err.MapOrAsync(10, x => new ValueTask<int>(x + 1))).ShouldBe(10);
    }
    ...
    public async Task WhenMapErrValueTaskAsync_ThenReturnMappedError()
    {
        ...
        Result<int, int> result =
            await err.MapErrAsync(_ => new ValueTask<int>(10));
