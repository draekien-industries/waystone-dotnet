...
namespace Waystone.Monads.Results.Features
{
    ...
    public partial class ResultAndErrorFactoriesThatDefaultTheErrorTypeToErrorFeature : object, Xunit.IClassFixture<ResultAndErrorFactoriesThatDefaultTheErrorTypeToErrorFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Results/Features", "Result and Error factories that default the error type to Error", null, global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Results/Features/ErrorResultFactories.feature.ndjson", 11);
        }
