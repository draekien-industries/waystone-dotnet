...
/// non-nullable.
/// </typeparam>
public sealed class MapWhileIterator<TItem, TOut> : Iterator<TOut>
    where TItem : notnull where TOut : notnull
{
    ...
    /// </summary>
    /// <typeparam name="TItem">
    /// The type of the elements to be iterated over. This type
    /// must be non-nullable.
    /// </typeparam>
    /// <typeparam name="TOut">
    /// The type of the elements generated by the mapping
    /// function. This type must also be non-nullable.
    /// </typeparam>
    public MapWhileIterator(
