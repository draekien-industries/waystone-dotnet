    ...
    where TErr : notnull
{
    ...
    /// <inheritdoc />
    public override Task<bool> IsOkAndAsync(Func<TOk, Task<bool>> predicate) =>
    ...
    /// <inheritdoc />
    public override Task<Result<TOut, TErr>> MapAsync<TOut>(
    ...
    /// <inheritdoc />
    public override Task<TOut> MapOrAsync<TOut>(
        TOut @default,
