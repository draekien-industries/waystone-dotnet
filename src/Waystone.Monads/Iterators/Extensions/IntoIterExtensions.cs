...
/// <summary>
/// Extensions for converting various types into an
/// <see cref="Iterator{T}" />.
/// </summary>
public static class IntoIterExtensions
{
    /// <summary>Converts an array of items into an <see cref="Iterator{T}" />.</summary>
    ...
    /// <summary>
    /// Converts any <see cref="IEnumerable{T}" /> of items into an
    /// <see cref="Iterator{T}" />.
    /// </summary>
    /// <typeparam name="T">The type of the value contained inside the array</typeparam>
    /// <param name="items">The array to iterate over</param>
